...
export default {
  ...
  "button-primary-background-color-hovered": Color.PRIMARY_DEFAULT_5,
  ...
  "button-secondary-background-color": Color.SECONDARY_DEFAULT_4,
  "button-secondary-border-color": Color.SECONDARY_DEFAULT_4,
  "button-secondary-color-hovered": Color.WHITE,
  "button-secondary-background-color-hovered": Color.SECONDARY_DEFAULT_5,
