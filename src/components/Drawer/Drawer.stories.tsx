...
const DrawerExample = ({
	...
	...args
}: Omit<React.ComponentProps<typeof Drawer>, "opened"> & {
	headerActions?: React.ReactNode;
	headerClosePlacement?: React.ComponentProps<typeof DrawerHeader>["closePlacement"];
...
export const NonModal: Story = {
	...
	render: (args) => <DrawerExample {...args} triggerLabel="Open non-modal drawer" />,
};
